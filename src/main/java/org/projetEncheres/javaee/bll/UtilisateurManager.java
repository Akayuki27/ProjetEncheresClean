...
{
	return utilisateur.login(pseudo,motDePasse);
}

public Utilisateur loginEmail(String email,String motDePasse) throws DALException
{
	return utilisateur.login(email,motDePasse);
}

public Utilisateur selectByPseudo (String pseudo) throws DALException {
	return utilisateur.selectByPseudo(pseudo);
}
